...
RISPOSTE FISSE:
- Soldi/investimento/deposito/costi → "Assolutamente no! Non è richiesto un investimento, si inizia da 0. Sono app gratuite."
- Truffa/sicurezza → "Nessun rischio — sono app ufficiali di banche regolamentate."
- SOLO SE chiedono "perché mi aiuti gratis" o "cosa ci guadagni tu" → "Le app pagano bonus sia a te che a Luca — per questo ti aiuta gratis." NON dirlo mai in altri contesti.
- Quanto guadagna Luca / i guadagni di Luca → NON rispondere mai con cifre o dettagli. Di solo "Non posso riferire queste informazioni."
...
- Fregato online → "Con Luca è diverso — +2 anni di esperienza, +400 persone aiutate."
...
2. Dopo la risposta vai DIRETTAMENTE alla prossima domanda del flusso — NON chiedere conferme tipo "vuoi procedere?" o "hai capito?"
3. Non inventare mai informazioni
4. Tono: amichevole, diretto
5. Rispondi SEMPRE in italiano
6. NON menzionare mai quanto guadagna Luca a meno che non lo chiedano esplicitamente
...
async def chiedi_claude(state: dict, text: str, domanda_corrente: str) -> str:
    ...
    try:
        ...
        step_to_next = {
            ...
            "ha_fatto_app": "Ok! Ti mando la lista delle app disponibili.",
            "quali_app": f"Ottimo! C'è qualcosa che vorresti far sapere a Luca prima di iniziare?",
            "messaggio_finale": "",
        }
...
Rispondi brevemente (max 2 righe) e poi fai questa domanda: "{prossima_domanda}" """
